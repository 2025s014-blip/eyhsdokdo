  ...
  try {
    ...
    try {
      ...
      if (question && question.includes("태정관")) {
        ...
        reflectionText = `신한일어업협정과 영해 기점, 그리고 배타적 경제수역(EEZ)에 이르기까지 복잡한 국제법의 역학을 ${cleanKeywords}라는 개념들을 통해 배우니 어업 주권에 대한 눈이 열렸습니다. 비록 어업 조정을 위해 중간수역으로 묶인 아픔과 갈등의 불씨가 잔존하지만, 이를 이성적으로 규명하고 자원의 공평한 분배 and 해양 환경 수호를 명확히 해결하는 것이 왜 필수적인지 깨닫는 시간이자 소중한 탐구 기회였습니다.`;
      } else {
